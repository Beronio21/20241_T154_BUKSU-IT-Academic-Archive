import {
  ...
  useMergedRefs_default2,
  useMounted,
  usePrevious,
  useWaitForDOMRef,
  useWillUnmount,
  useWindow
} from "./chunk-VEKHTY5L.js";
import {
  require_prop_types
} from "./chunk-OKSY5JJH.js";
import {
  require_jsx_runtime
...
function useTimeout() {
  ...
  const handleRef = (0, import_react20.useRef)();
...
function forEach(children, func) {
  ...
  React36.Children.forEach(children, (child) => {
    if (React36.isValidElement(child)) func(child, index++);
  });
}
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react28.default)["useSyncExternalStore"] === "function") return (0, import_react28.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react31.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react31.useRef)(null);
  const focusInDropdown = (0, import_react31.useRef)(false);
  const onSelectCtx = (0, import_react31.useContext)(SelectableContext_default);
  const toggle = (0, import_react31.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context6 = (0, import_react31.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react31.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react32.useLayoutEffect : import_react32.useEffect;
...
var FormLabel = React70.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime64.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var Switch = React74.forwardRef((props, ref) => (0, import_jsx_runtime68.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Offcanvas = React94.forwardRef(({
  ...
  const renderBackdrop = (0, import_react53.useCallback)((backdropProps) => (0, import_jsx_runtime88.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React95.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context6 = (0, import_react54.useContext)(NavbarContext_default);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime105.jsxs)(import_jsx_runtime104.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react60.cloneElement)(children, triggerProps), (0, import_jsx_runtime103.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react62.useContext)(TabContext_default);
...
var TabContent = React119.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React120.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React123.forwardRef((props, ref) => (0, import_jsx_runtime126.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React124.createContext({
  onClose() {
  }
});
...
var ToastHeader = React125.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context6 = (0, import_react64.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastBody = React126.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React128.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React129.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React130.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
